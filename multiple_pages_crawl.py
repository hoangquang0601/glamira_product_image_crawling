...
# URLs and their corresponding output directories
tasks = [
    ("https://www.glamira.com/plain-design-jewelry/?p=6", "D:\\Download\\Data Engineer K9\\Crawling\\plain-design-jewelry"),
    ("https://www.glamira.com/ceramic-jewellery/?p=6", "D:\\Download\\Data Engineer K9\\Crawling\\ceramic-jewellery"),
    ("https://www.glamira.com/pearl-necklaces/?p=6", "D:\\Download\\Data Engineer K9\\Crawling\\pearl-necklaces")
]

# Create threads for each task
threads = []
for url, output_dir in tasks:
    thread = threading.Thread(target=scrape_website, args=(url, output_dir))
